...
const features = [
  { icon: MapPin, text: "Tracks ambulance location in real time" },
  { icon: Bell, text: "Sends alerts to nearby vehicles" },
  { icon: Shield, text: "Notifies traffic police and control rooms" },
  { icon: TrafficCone, text: "Automatically controls traffic signals" },
  { icon: Route, text: "Creates a Green Corridor for fast movement" },
];
    ...
    <div className="grid lg:grid-cols-2 gap-16 items-center">
      <div>
        ...
        <h2 className="text-3xl md:text-5xl font-bold mb-6">
          A Smart and Automated Traffic Clearance System
        </h2>
        <p className="text-muted-foreground text-lg mb-8">
          Intentovex provides a unified system that ensures every second counts during an emergency.
        </p>
